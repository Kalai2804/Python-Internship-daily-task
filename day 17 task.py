...
dbse = mydb.cursor()
dbse.execute("CREATE TABLE Office (emp_name VARCHAR(100), Employee_id VARCHAR(100) ,EMP_ADDRESS VARCHAR(100))")
dbse = mydb.cursor()
dbse.execute("CREATE TABLE Student(rollno INT(24) , STUD_NAME VARCHAR(100) , MARK INT(3))")
...
sql = "INSERT INTO Employee1 (id, name, address) VALUES (%s, %s,%s)"
val = ("125","ragnar","Kamarajar Salai 58")
mycursor.execute(sql, val)
